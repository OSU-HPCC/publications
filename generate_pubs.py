...
def main():
    ...
    '''
    # Remove functionality for technical reports
    # Treat technical reports as general articles
    # Commented out thoughout code in case we change
    # our mind.
    ...
    for year in years:
        ...
        if thatYearsPubs(year, articles):
            '''
            Now that the only type of publication
            the scripts handles is articles,
            we don't need the heading articles
            under each year.
